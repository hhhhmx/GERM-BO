...
\author[1,6]{Mingxuan Huang}
\author[2,6]{Jingchao Wang}
\author[3,6]{Yang Shi}
\author[1,6]{Miyang Yang}
\author[4,6]{Zhaochu Wang}
\author[5]{Dayou Chen}
\author[1,7,*]{Xi Sun}
\affil[1]{Zhongshan School of Medicine, Sun Yat-sen University, Guangzhou, China}
\affil[2]{School of Computer Science, Peking University, Beijing, China}
\affil[3]{School of Computer Science and Technology, Guangdong University of Technology, Guangzhou, China}
\affil[4]{Department of Anorectal Surgery, The Affiliated People's Hospital of Fujian University of Traditional Chinese Medicine, Fuzhou, China}
\affil[5]{School of Computer Science, Sun Yat-sen University, Guangzhou, China}
\affil[6]{These authors contributed equally}
\affil[7]{Lead contact}
\affil[*]{Correspondence: sunxi2@mail.sysu.edu.cn}
...
Requests for further information and resources should be directed to and will be fulfilled by the lead contact, Xi Sun (sunxi2@mail.sysu.edu.cn).
...
\begin{itemize}
  ...
  \item A permanent public archive with DOI will be created before publication through Zenodo. Until the archive is active, all materials required to reproduce the reported analyses are available at \url{https://github.com/hhhhmx/GERM-BO.git} and from the lead contact upon reasonable request.
\end{itemize}
\endgroup

\section*{ACKNOWLEDGMENTS}
We thank our research group and advisors for helpful discussions and feedback on this manuscript. We gratefully acknowledge the maintainers of the UCI Machine Learning Repository, Genomic Benchmarks, Hugging Face, and the Nucleotide Transformer downstream benchmark collection for publicly releasing the sequence datasets and model checkpoints used in this study. Computational experiments were performed using institutional GPU computing resources. This work was supported by the Guangzhou National Laboratory Major Project (GZNL2024A01003) to Xi Sun.

\section*{AUTHOR CONTRIBUTIONS}
M.H., J.W., Y.S., M.Y., and Z.W. contributed equally to this work. Conceptualization, J.W. and Y.S.; methodology, M.H., J.W., Y.S., M.Y., and Z.W.; software, M.H.; investigation, M.H., M.Y., and Z.W.; visualization, M.H.; writing--original draft, M.H. and Y.S.; writing--review \& editing, all authors; supervision, X.S.
