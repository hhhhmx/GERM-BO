...
BASELINE_TEMPLATE = {
    ...
    "debug": {
        ...
        "epochs": 1,
        "max_steps": 4,
        "output_subdir": "debug_real_nt_v2_50m_baseline_TASK_pilot",
    },
...
GERM_BO_TEMPLATE["debug"]["output_subdir"] = "debug_real_nt_v2_50m_germ_bo_TASK_center_jsd_pilot"
...
def main():
    ...
    for task in HISTONE_MARKS:
        baseline_path = config_dir / f"real_nt_v2_50m_baseline_{task}_pilot.yaml"
        germ_bo_path = config_dir / f"real_nt_v2_50m_germ_bo_{task}_center_jsd_pilot.yaml"
